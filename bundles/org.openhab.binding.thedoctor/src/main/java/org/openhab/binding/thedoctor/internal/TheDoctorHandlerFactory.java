...
import static org.openhab.binding.thedoctor.internal.TheDoctorBindingConstants.THING_TYPE_DOCTOR;
...
/**
 * The {@link TheDoctorHandlerFactory} is responsible for creating things and thing
 * handlers.
 *
...
public class TheDoctorHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_DOCTOR.equals(thingTypeUID)) {
            return new TheDoctorHandler(thing);
        }
